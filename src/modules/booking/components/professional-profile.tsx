...
import type { PublicProfessionalProfile } from "@/modules/booking/types/booking.types";
...
export function ProfessionalProfile({ profile }: ProfessionalProfileProps) {
  ...
  function handleContinue() {
    const params = new URLSearchParams({ professionalId: profile.id, serviceIds: serviceIds.join(",") });
