...
import type { ProfessionalPerformanceRow } from "@/modules/reports/types/period-report.types";

export function ProfessionalPerformanceTable({ data }: { data: ProfessionalPerformanceRow[] }) {
  if (data.length === 0) {
