...
import { professionalStatusValues } from "@/modules/professionals/schemas/professional.schema";
...
export function ProfessionalFilters({ search, status }: ProfessionalFiltersProps) {
