...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Contas a Pagar", href: "/contas-a-pagar", icon: "ReceiptText", permission: PERMISSIONS.payables.view },
  { label: "Contas a Receber", href: "/contas-a-receber", icon: "HandCoins", permission: PERMISSIONS.receivables.view },
  { label: "Comissões", href: "/comissoes", icon: "BadgePercent", permission: PERMISSIONS.commissions.view },
